...
<div class="container text-dark">
    <div class="row col-12 text-right mb-3">
        <button type="button" class="btn btn-outline-primary w-25" id="add_product" data-bs-toggle="modal" data-bs-target="#add_new_product"><i class="fas fa-user-plus"></i> Add New Product</button>
    </div>
